			...
			<div class="box-body">
	            ...
	            <div class="form-group">
					...
					<div class="col-xs-9" style="padding: 5px 0px 0px 0px;">
						...
						<input name="sex" type="radio" checked="checked" value="0" <c:if test="${valmap.sex eq'0'}">checked</c:if>/>男 </label>
						<label class="col-xs-3 control-label">
						<input name="sex" type="radio" value="1" <c:if test="${valmap.sex eq'1'}">checked</c:if>/>女 </label>
					</div>
	            </div>
<!-- 	            <div class="form-group"> -->
