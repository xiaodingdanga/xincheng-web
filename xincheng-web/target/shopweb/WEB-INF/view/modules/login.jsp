	...
	<div class="login-logo">
  	...
  	<div class="login-box-body">
    	...
    	<form action="<%=ctx %>/login/login" id="form" name="form" method="post">
      	...
      	<div class="row">
        	<div class="col-xs-12">
          		<button type="button" class="btn btn-primary btn-block btn-flat" onclick="tologin();" onKeyPress="passwordPress(event)">登陆</button>
        	</div>
      	</div>
  	</div>
</div>
...
<script type="text/javascript">
	...
	if(host=="cloud.udour.cn"){
		$("#logo").html("${logo}");
		$("#proname").html("${proname}");
	}else if(host=="zypwt.udour.cn"){
		$("#logo").html("中演票务通文化发展有限责任公司");
		$("#proname").html("中演票务通景区管理系统");
	} 
</script>
</html>
