...
function init(height){
    ...
    jQuery("#table").jqGrid({
        ...
        colModel:[//列对应的字段id,name,tel,address,remark,isdel,isIP,sort
        	...
        	{name:'isIP',index:'isIP',width:40,formatter: "select", editoptions:{value:"0:否;1:是"}}, 
        	{name:'address',index:'address',width:100,sortable:false},   
        	{name:'remark',index:'remark',width:75,sortable:false},   
         	{name:'Edit',index:'Edit',width:220}
        ],
